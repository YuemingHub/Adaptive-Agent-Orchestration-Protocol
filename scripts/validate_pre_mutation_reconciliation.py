...
def main() -> int:
    ...
    require(GUARD_ID in case.get("required_guard_ids", []), "pressure case must require reconciliation guard")
    ...
    print(
        ...
        "project-independent current-baseline trust gate; stale derived evidence, conflicts, "
        "and unknowns remain distinct without consumer-specific Core semantics"
    )
    return 0
