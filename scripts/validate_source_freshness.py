...
def main() -> int:
    ...
    require(
        ...
        f"README status must identify v{version}",
    )
    ...
    print(
        f"PASS source freshness: v{version} release identity is distinct; stable-managed current/stale/offline and exact-frozen/local policies remain separate"
    )
    return 0
